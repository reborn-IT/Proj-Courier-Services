...
function DeleteConfirmationModal({
  ...
  return (
    <div
      ...
      } rounded-2xl p-8 bg-drop-white z-50 overflow-y-auto h-auto drop-shadow-2xl fixed top-1/2 left-1/2 transform -translate-x-1/2`}
    >
      ...
      <div className="flex items-center justify-end">
        {links.map(({ id, linkName, linkTo, color }) => (
