  ...
  return (
    <div className="modal rounded-2xl p-8 bg-drop-white fixed overflow-y-auto w-[95%] lg:w-3/5 h-auto z-50 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
      <div className="flex items-center justify-between">
        <h4 className="text-4xl text-drop-primary font-semibold">Save filter information?</h4>
        <ModalCloseButton ClickHandler={() => CloseModal()} />
      </div>
      <p className="text-base lg:text-xl font-semibold my-8 text-drop-grey">Save your filter data, so you can directly see and access them in your profile.</p>
      <form className="form">
        <p className="mb-3">
          Title
