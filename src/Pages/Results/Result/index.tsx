...
const SERVICES_LIST = [
  {
    ...
    description:
      "If you feel that your document or package needs to be delivered with high priority, this is the service for you. Within Colombo (1-15) we ensure that your packages of utmost importance will be delivered on the same day. (T & C applied)",
  },
  {
    id: 2,
...
const SAMPLE_REVIEWS: IReviewCard[] = [
  {
    ...
    time: "12.34 PM",
    description:
      "Possibly the fault of the sender, I'm supposed to receiver a free sample but am getting charged sales tax on it.",
    rating: 3,
    photos: [
      {
        id: 1,
...
function Result() {
  ...
  const onGrabData = (currentPage: any) =>
    new Promise((resolve) => {
      setTimeout(() => {
        const data2 = SAMPLE_REVIEWS.slice(
      ...
      <section className="container px-5 xl:px-0 mx-auto mt-6">
        <div className="content-para">
          <div className="title flex items-center text-4xl lg:text-6xl justify-between font-semibold text-drop-grey mb-3">
            ...
            {!fav ? (
              <button
                type="button"
                className="active:scale-75 transform transition-all hover:scale-110"
                onClick={() => favHandler(true)}
              >
        ...
        <div className="services mt-5">
          ...
          <div className="flex flex-wrap mt-3">
            {SERVICES_LIST.map(({ id, title, description }) => (
              <CourierService
                onClickHandler={() => ServiceItemHandler(title, description)}
                key={id}
                serviceName={title}
                optionalTailwindCss="mb-3 mr-3"
              />
            ))}
          </div>
        </div>
        ...
        <div className="contact mt-5">
          ...
          <div className="mt-3 flex flex-col space-y-4">
            <p>
              Web:{" "}
              <span>
                <a href="/domex.lk" className="text-drop-blue">
                  Domex.lk
                </a>
              </span>
            </p>
            <p>
              Hotline:{" "}
              <span>
                <a href="tel:0777 123 456" className="text-drop-blue">
                  0777 123 456
                </a>
              </span>
            </p>
            <p>
              Nearest Branch:{" "}
              <span>
                <button type="button" className="text-drop-blue">
                  Negombo
                </button>
              </span>
            </p>
        ...
        <div className="reviews mt-10 mb-36">
          <h3 className="text-3xl font-semibold text-drop-grey">
            Customer Reviews <span className="text-drop-primary">2365+</span>
          </h3>
          ...
          <div className="bars mt-8">
            {REVIEW_CATEGORIES.map(({ id, category, percentage }) => (
              <div
                key={id}
                className="flex space-x-5 items-center text-drop-primary font-semibold text-xl mb-2"
              >
                <input
                  id="one"
                  type="checkbox"
          ...
          <div
            ref={triggerRef}
            className={classNames({ visible: loading }, "trigger")}
          />
        </div>
