...
function FilterLog() {
  ...
  const filterLogRef: any = useRef(null);
  ...
  function deleteHandler() {
    if (currentDeletingList) {
      if (currentDeletingList?.length >= 1) {
        ...
        >
          ...
          <div className="flex items-center space-x-4">
            <button
              ...
              ref={filterLogRef}
              disabled={!isDeleting}
              className={`text-drop-red text-2xl ${
                isDeleting
                  ? "cursor-pointer"
            ...
            <button
              ...
              className="text-drop-grey text-2xl"
            >
