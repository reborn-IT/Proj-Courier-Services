...
function ReviewCard({
  ...
  return (
    <div className={`shadow-md px-4 md:px-8 py-3 md:py-5 rounded-xl ${additionalTailwindCss}`}>
      <div className="flex items-center justify-between">
        <div className="user flex items-center">
          <img src={profileUrl} alt="User" className="object-cover w-12 md:w-14 h-12 md:h-14 rounded-full" />
