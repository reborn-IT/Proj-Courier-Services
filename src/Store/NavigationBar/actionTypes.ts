...
export const FETCH_NAVIGATION_BAR_STATE_REQUEST = 'FETCH_NAVIGATION_BAR_STATE_REQUEST';
export const FETCH_NAVIGATION_BAR_STATE_SUCCESS = 'FETCH_NAVIGATION_BAR_STATE_SUCCESS';
export const FETCH_NAVIGATION_BAR_STATE_FAILURE = 'FETCH_NAVIGATION_BAR_STATE_FAILURE';
