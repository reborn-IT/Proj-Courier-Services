...
export const FETCH_COURIER_SERVICE_LABEL_STATE_REQUEST =
  "FETCH_COURIER_SERVICE_LABEL_STATE_REQUEST";
export const FETCH_COURIER_SERVICE_LABEL_STATE_SUCCESS =
  "FETCH_COURIER_SERVICE_LABEL_STATE_SUCCESS";
export const FETCH_COURIER_SERVICE_LABEL_STATE_FAILURE =
